// Replace your NameValidationDialog component with this code:
"use client"
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            We found some differences between the names in your {documentType} document and your profile information.
          </DialogDescription>
        </DialogHeader>
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex items-center justify-between">
                ...
                <Badge variant={confidence > 0.7 ? "default" : "destructive"}>
        ...
        <DialogFooter className="flex-col sm:flex-row gap-2">
          ...
          <Button variant="outline" onClick={() => handleConfirm(false)} disabled={loading} className="w-full sm:w-auto">
            Update Profile First
          </Button>
          <Button onClick={() => handleConfirm(true)} disabled={loading} className="w-full sm:w-auto">
